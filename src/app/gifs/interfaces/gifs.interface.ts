// To parse this data:
//
//   import { Convert, GiphySearchResponse } from "./file";
//
//   const giphySearchResponse = Convert.toGiphySearchResponse(json);
//
...
export class Convert {
  public static toGiphySearchResponse(json: string): GiphySearchResponse {
      return cast(JSON.parse(json), r("GiphySearchResponse"));
  }

  public static giphySearchResponseToJson(value: GiphySearchResponse): string {
      return JSON.stringify(uncast(value, r("GiphySearchResponse")), null, 2);
  }
}
